...
function buildPolicyHtml(answers) {
  ...
  if (rationaleItems.length) {
    rationaleItems.unshift("מטרת מדניות השימוש בבינה מלאכותית בקורס היא שמירה על מטרות הקורס ואיכות הלמידה בעידן בו כלי AI נגישים וזמינים לסטודנטים.");
  }
